    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
        <div class="container">
            <a href="/" class="navbar-brand">
                <img src="/resources/image/mine.jpg" alt="Logo"
...
<h3><i class="fas fa-exclamation-triangle text-danger"></i> 500 Error Page </h3>
<p>
Error 발생
첫 화면에서 다시 시작하세요 <a href="/"> 로그인 화면으로 이동합니다. </a> 검색 기능을 사용하여 이동할 수 있습니다. 
</p>
